            ...
            <div className='h-2/4 flex flex-col items-center'>
                <ul className='h-full flex flex-col justify-evenly'>
                    ...
                    <li className='sidebariconbox'>
                        ...
                        {isloggedIn?<p className='text-base'>Profile</p>:<Link to={'/login'} className='text-base'>Login</Link>}
                    </li>
                </ul>
            </div>
        </div>
        ...
        <>
            ...
            {isHomePage || isexplore ? <div className="flex fixed bottom-0 w-screen h-20 bg-white border-t justify-evenly items-center md:hidden">
                ...
                <div className='bottomiconbox'>
                    ...
                    {isloggedIn?<p className='text-xs'>ProfileP</p>:<Link to={'/login'} className='text-xs'>Login</Link>}
                </div>
            </div>:<></>}
        </>
    )
