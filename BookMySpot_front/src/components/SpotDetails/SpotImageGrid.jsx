...
function SpotImageGrid() {
    ...
    return (
        <div className='flex flex-col h-96 md:flex-row w-full gap-1 shadow-sm cursor-pointer '>
            <div className='h-1/2 md:h-full w-full md:w-1/2 md:shrink:0'>
                <img
                    placeholder={'Image'}
                    src={imageUrl}
                    className='h-full w-full md:rounded-l-lg rounded-t-lg'
                />
            </div>
            <div className='flex flex-col h-1/2 md:h-full w-full md:w-1/2 gap-0.5'>
                <div className='flex h-1/2 w-full gap-0.5'>
                    <div className='h-full w-1/2 md:shrink:0'>
                        <img
                            placeholder={'Image'}
                            src={imageUrl}
                    ...
                    <div className='h-full w-1/2 md:shrink:0'>
                        <img
                            placeholder={'Image'}
                            src={imageUrl}
                            className='h-full w-full md:rounded-tr-lg'
                        />
                    </div>
                </div>
                <div className='flex h-1/2 w-full gap-0.5'>
                    <div className='h-full w-1/2 md:shrink:0'>
                        <img
                            placeholder={'Image'}
                            src={imageUrl}
                            className='h-full w-full rounded-bl-lg md:rounded-none'
                        />
                    </div>
                    <div className='h-full w-1/2 md:shrink:0'>
                        <img
                            placeholder={'Image'}
                            src={imageUrl}
                            className='h-full w-full rounded-br-lg md:rounded-br-lg'
                        />
